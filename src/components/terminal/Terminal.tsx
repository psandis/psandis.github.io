...
const COMMANDS: Record<string, () => string[]> = {
  ...
  skills: () => [
    ...
    "  Kafka (Confluent) · Azure Event Hub · Apigee",
    "  TIBCO BW · TIBCO EMS · JMS · REST/SOAP",
    "",
    "Platforms:",
    "  Salesforce (Sales/Service/Vlocity CPQ)",
    "  Comarch CRM · WordPress",
    "",
    "Observability:",
    "  Splunk · Elastic Stack · Azure Monitor · Grafana",
    "",
    "CI/CD & Dev Tools:",
    "  GitHub Actions · Jenkins · Jira · Confluence",
    "  Cursor · VS Code · Linear",
    "",
    "Databases:",
    "  Oracle · PostgreSQL · MySQL · DB2 · Redis",
    "",
    "AI:",
    "  Claude · OpenAI · AI-assisted development",
  ],
  contact: () => [
    "┌─────────────────────────────────────────────┐",
